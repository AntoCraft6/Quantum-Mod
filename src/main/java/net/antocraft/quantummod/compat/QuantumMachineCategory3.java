...
public class QuantumMachineCategory3 implements IRecipeCategory<QuantumMachineRecipe3> {
    public static final ResourceLocation UID = new ResourceLocation(QuantumMod.MOD_ID, "quantum_machine_3");
    public static final ResourceLocation TEXTURE = new ResourceLocation(QuantumMod.MOD_ID, "textures/gui/quantum_machine_3_gui.png");

    public static final RecipeType<QuantumMachineRecipe3> QUANTUM_MACHINE_3_TYPE = new RecipeType<>(UID, QuantumMachineRecipe3.class);

    private final IDrawable background;
    private final IDrawable icon;

    public QuantumMachineCategory3(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 85);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(QuantumMachineEntry.QUANTUM_MACHINE_3.get()));
    }

    @Override
    public RecipeType<QuantumMachineRecipe3> getRecipeType() {
        return QUANTUM_MACHINE_3_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("block.quantummod.quantum_machine_3");
    }
    ...
    @Override
    public void draw(QuantumMachineRecipe3 recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
