...
public class RefinedRecipe1 implements RecipeBuilder {
    ...
    public RefinedRecipe1(ItemLike output, int countOut) {
        this.output = output.asItem();
        this.countOut = countOut;
    }

    public static RefinedRecipe1 output(ItemLike output) {
        return new RefinedRecipe1(output, 1);
    }

    public static RefinedRecipe1 output(ItemLike output, int countOut) {
        return new RefinedRecipe1(output, countOut);
    }

    public RefinedRecipe1 input(TagKey<Item> tag) {
        return this.input(Ingredient.of(tag));
    }

    public RefinedRecipe1 input(ItemLike input) {
        return this.input(input, 1);
    }

    public RefinedRecipe1 input(ItemLike input, int countIn) {
        return this.input(Ingredient.of(input), countIn);
    }

    public RefinedRecipe1 input(Ingredient input) {
        return this.input(input, 1);
    }

    public RefinedRecipe1 input(Ingredient input, int countIn) {
        this.input.add(input);
        this.countIn = countIn;
        return this;
    }

    public RefinedRecipe1 energy(int energy) {
        this.energy = energy;
        return this;
    }

    public RefinedRecipe1 unlockedBy(String name, CriterionTriggerInstance trigger) {
        this.advancement.addCriterion(name, trigger);
        return this;
    }

    public RefinedRecipe1 group(@Nullable String group) {
        this.group = group;
        return this;
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId) {
        ...
        consumer.accept(new Result(recipeId, this.output, this.countOut, this.group == null ? "" : this.group, this.energy, this.input, this.countIn, this.advancement, recipeId.withPrefix("recipes/refinement_1/")));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return QuantumMachineRecipe1.Serializer.INSTANCE;
        }
