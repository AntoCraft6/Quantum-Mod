...
public class QuantumMachineRecipe2 implements Recipe<Container> {
    ...
    public QuantumMachineRecipe2(NonNullList<Ingredient> input, int inputSize, ItemStack output, int energy, ResourceLocation id) {
        this.input = input;
    ...
    public static class Serializer implements RecipeSerializer<QuantumMachineRecipe2> {
        ...
        @Override
        public QuantumMachineRecipe2 fromJson(ResourceLocation id, JsonObject json) {
