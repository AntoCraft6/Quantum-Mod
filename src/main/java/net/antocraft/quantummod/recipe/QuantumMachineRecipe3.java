...
public class QuantumMachineRecipe3 implements Recipe<SimpleContainer> {
    private final NonNullList<Ingredient> inputItems;
    private final ItemStack output;
    private final ResourceLocation id;

    public QuantumMachineRecipe3(NonNullList<Ingredient> inputItems, ItemStack output, ResourceLocation id) {
    ...
    public static class Serializer implements RecipeSerializer<QuantumMachineRecipe3> {
        ...
        @Override
        public QuantumMachineRecipe3 fromJson(ResourceLocation recipeId, JsonObject serializedRecipe) {
            ...
            return new QuantumMachineRecipe3(inputs, output, recipeId);
        }

        @Override
        public @Nullable QuantumMachineRecipe3 fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
